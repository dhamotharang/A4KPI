...
export const environment = {
  ...
  apiUrlEC: 'http://localhost:80/api/',
  apiUrl: 'http://10.4.5.132:1011/api/',
  apiUrl2: 'http://10.4.5.132:1011/api/',
  hub: 'http://localhost:80/ec-hub',
  scalingHub: 'http://localhost:80/ec-hub',
